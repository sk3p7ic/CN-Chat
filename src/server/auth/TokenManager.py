...
class TokenManager(DatabaseManager):
    ...
    def verify_token(self, user_id: int, token: Token):
        """
    ...
    def add_user(self, username: str, password: str):
        ...
        :param token: The token for the user that will be added.
        ...
        token = Token().get_token()  # Generate a new token for the user
